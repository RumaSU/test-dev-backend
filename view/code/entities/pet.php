<?php
    $file_path = __DIR__ . DIRECTORY_SEPARATOR . '../../../core/entities/Pet.php';
    $file_name = 'Core\Entities\Pet';
?>
        ...
        <div class="bg-white p-4 rounded-lg shadow-md mb-6">
            ...
            <nav class="border border-gray-300 rounded p-4 bg-gray-50">
                <ul class="space-y-2">
                    ...
                    <li class="ml-4">
                        <a href="pet.php" class="text-blue-600 hover:text-blue-800 font-medium">Pet</a>
                    </li>
