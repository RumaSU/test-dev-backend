<?php
    $file_path = __DIR__ . DIRECTORY_SEPARATOR . '../../../core/lib/Json.php';
    $file_name = 'Core\Lib\Json';
?>
            ...
            <nav class="border border-gray-300 rounded p-4 bg-gray-50">
                <ul class="space-y-2">
                    ...
                    <ul class="ml-4 space-y-1">
                        <li><a href="arr.php" class="text-blue-600 hover:text-blue-800">Arr</a></li>
                        <li><a href="json.php" class="text-blue-600 hover:text-blue-800 font-medium">Json</a></li>
                        <li><a href="mat.php" class="text-blue-600 hover:text-blue-800">Mat</a></li>
                        <li><a href="str.php" class="text-blue-600 hover:text-blue-800">Str</a></li>
                    </ul>
