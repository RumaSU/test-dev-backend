<?php
    $file_path = __DIR__ . DIRECTORY_SEPARATOR . '../../../core/lib/Arr.php';
    $file_name = 'Core\Lib\Arr';
?>
            ...
            <nav class="border border-gray-300 rounded p-4 bg-gray-50">
                <ul class="space-y-2">
                    ...
                    <ul class="ml-4 space-y-1">
                        <li><a href="arr.php" class="text-blue-600 hover:text-blue-800 font-medium">Arr</a></li>
